 ...
 * 作用：用于完成对某一张数据表的具体操作——ORM操作。
 * 声明：版权归作者所有
 */

public class PersonDaoUtils {
    private static String TAG = PersonDaoUtils.class.getSimpleName();
     ...
     * @param context
     */
    public PersonDaoUtils(Context context) {
    ...
    public List<PersonBean> queryMeiziByQueryBuilder(long id) {
        ...
        return queryBuilder.where(PersonBeanDao.Properties.Id.eq(id)).list();
    }
